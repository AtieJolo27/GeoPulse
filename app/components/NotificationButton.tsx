  ...
  return (
    <>
      <TouchableOpacity
        ...
        accessibilityLabel={
          alerts.length
            ? `${alerts.length} notifications. Open notifications`
            : 'Open notifications'
        }
        style={{
          width: 36,
      ...
      >
        ...
        >
          <Pressable
            className="absolute rounded-3xl p-5"
            style={{
              top: 66,
              right: 16,
              width: '88%',
          ...
          >
            <View className="flex-row items-center">
              <View className="flex-1 flex-row items-center pr-2">
                <Ionicons name="notifications-outline" size={24} color="#1B5E37" />
                <View className="ml-2 flex-1">
                  <Text className="text-base font-extrabold" style={{ color: '#173D28' }}>
                    {t('Notifications', 'Mga Notipikasyon')}
                  </Text>
                  <Text className="text-xs" numberOfLines={2} style={{ color: '#5C6F63' }}>
                    {t(
                      'Tap an alert to view its recommendation.',
                      'Pindutin ang alerto upang makita ang rekomendasyon.'
                    )}
                  </Text>
                </View>
              </View>
              ...
              >
                <Ionicons name="close" size={24} color="#365443" />
              </TouchableOpacity>
            </View>
            ...
            {loading ? (
              ...
              <View className="items-center py-9">
                ...
                <Text className="mt-3 text-center text-sm" style={{ color: '#365443' }}>
                  {t(
                    'No alerts - all sensors are within optimal range.',
                    'Walang alerto - lahat ng sensor ay nasa optimal na antas.'
                  )}
                </Text>
              </View>
            ) : (
